...
class ThreeInOne(nn.Module):
    def __init__(self, args):
        ...
        # self.fc_final = nn.Linear(res_channels['resnet50'][-1]*4, num_classes, bias=True)
        self.fc_final = nn.Linear(res_channels['resnet50'][-1], num_classes, bias=True)
    ...
    def forward(self, ct_data, pet_data):
        ...
        x = self.fc_final(ct_img.squeeze())
